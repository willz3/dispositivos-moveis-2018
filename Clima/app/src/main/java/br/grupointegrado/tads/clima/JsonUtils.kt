...
//        val OWM_TEMPERATURE = "temp"
        ...
        fun getSimplesStringsDeClimaDoJson(context: Context, stringJsonPrevisao: String): Array<String>? {
            ...
            dadosDoClima = Array<String>(arrayClima.length()){ "it = $it" }
